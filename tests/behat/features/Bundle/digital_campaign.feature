Feature: Digital Campaign Bundle
  ...
  Scenario: Create An A/B test.
    ...
    When I am on "block/add/a-b-block"
      ...
      And I fill in "edit-field-block-option-und-0-field-block-und-0-target-id" with "Text Block A"
      And I fill in "edit-field-block-option-und-0-field-percentage-und-0-value" with "100"
      And I press "Add another item"
      And I fill in "edit-field-block-option-und-1-field-block-und-0-target-id" with "Text Block B"
